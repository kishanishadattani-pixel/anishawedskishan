(() => {
  ...
  if (map) {
    ...
    // ensure it has a reasonable height on mobile if Webflow left it awkward
    const mq = window.matchMedia("(max-width: 768px)");
    if (mq.matches && !map.style.minHeight) map.style.minHeight = "320px";
  ...
  initSlideshow(qAny([".section-slideshow", "#section-slideshow", ".photos-slideshow", "#photos-slideshow", "[data-photos-slideshow]"]), [['media/photos/ka-slideshow-1.png', 'media/photos/ka-slideshow-1.png', 'media/photos/ka-slideshow-1.png', 'media/photos/ka-slideshow-1.webp'], ['media/photos/ka-slideshow-2.png', 'media/photos/ka-slideshow-2.png', 'media/photos/ka-slideshow-2.png', 'media/photos/ka-slideshow-2.webp'], ['media/photos/ka-slideshow-3.png', 'media/photos/ka-slideshow-3.png', 'media/photos/ka-slideshow-3.png', 'media/photos/ka-slideshow-3.webp'], ['media/photos/ka-slideshow-4.png', 'media/photos/ka-slideshow-4.png', 'media/photos/ka-slideshow-4.png', 'media/photos/ka-slideshow-4.webp'], ['media/photos/ka-slideshow-5.png', 'media/photos/ka-slideshow-5.png', 'media/photos/ka-slideshow-5.png', 'media/photos/ka-slideshow-5.webp'], ['media/photos/ka-slideshow-6.png', 'media/photos/ka-slideshow-6.png', 'media/photos/ka-slideshow-6.png', 'media/photos/ka-slideshow-6.webp'], ['media/photos/ka-slideshow-7.png', 'media/photos/ka-slideshow-7.png', 'media/photos/ka-slideshow-7.png', 'media/photos/ka-slideshow-7.webp'], ['media/photos/ka-slideshow-8.png', 'media/photos/ka-slideshow-8.png', 'media/photos/ka-slideshow-8.png', 'media/photos/ka-slideshow-8.webp'], ['media/photos/ka-slideshow-9.png', 'media/photos/ka-slideshow-9.png', 'media/photos/ka-slideshow-9.png', 'media/photos/ka-slideshow-9.webp'], ['media/photos/ka-slideshow-10.png', 'media/photos/ka-slideshow-10.png', 'media/photos/ka-slideshow-10.png', 'media/photos/ka-slideshow-10.webp']]);
  ...
  // Keep venue slideshow box aligned with the map box on desktop (do not affect mobile)
  function syncVenueHeights() {
    try {
      const isDesktop = window.matchMedia("(min-width: 769px)").matches;
      const mapEl = qAny([".venue-map", "#venue-map", "[data-venue-map]"]);
      const slideEl = qAny([".venue-slideshow", "#venue-slideshow", "[data-venue-slideshow]"]);
      if (!mapEl || !slideEl) return;
      ...
      const h = Math.max(Math.round(mapRect.height), minSize);
      const w = Math.max(Math.round(mapRect.width), minSize);

      slideEl.style.height = h + "px";
      slideEl.style.width = w + "px";
      slideEl.style.minHeight = minSize + "px";
      slideEl.style.minWidth = minSize + "px";
      slideEl.style.maxWidth = w + "px";
    } catch {}
  }

  // Run after layout settles and on resize
  window.addEventListener("load", () => { setTimeout(syncVenueHeights, 50); setTimeout(syncVenueHeights, 500); }, { once:true });
  window.addEventListener("resize", () => { syncVenueHeights(); });

(() => {
  ...
  function preloadAssets(urls) {
    urls.forEach((u) => {
      // Images
      if (u.match(/\.(png|jpg|jpeg|webp)$/i)) {
        const img = new Image();
        img.decoding = "async";
        img.loading = "eager";
        img.src = u;
  ...
  const PRELOAD_URLS = [
    ...
    "media/venue/aviyana-slideshow-1.jpg", "media/venue/aviyana-slideshow-2.jpg", "media/venue/aviyana-slideshow-3.jpg", "media/venue/aviyana-slideshow-4.jpg", "media/venue/aviyana-slideshow-5.jpg", "media/venue/aviyana-slideshow-6.jpg", "media/venue/aviyana-slideshow-7.jpg",
    "media/photos/ka-slideshow-1.JPG", "media/photos/ka-slideshow-2.JPG", "media/photos/ka-slideshow-3.JPG", "media/photos/ka-slideshow-4.JPG", "media/photos/ka-slideshow-5.JPG", "media/photos/ka-slideshow-6.JPG", "media/photos/ka-slideshow-7.JPG", "media/photos/ka-slideshow-8.JPG", "media/photos/ka-slideshow-9.JPG", "media/photos/ka-slideshow-10.JPG"
  ];
